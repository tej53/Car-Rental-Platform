    ...
    return (
        ...
        max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden">
            <div className="text-white">
                <h2 className="text-3xl font-medium">Do you own a luvury car?</h2>
                <p className="mt-2">Monetize your vehicle effortlessly by listing it on car rental.</p>
                <p className="msx-w-130">We take care of insurance, driver verification and secure payments - so you can earn passive income, stress-free.</p>
