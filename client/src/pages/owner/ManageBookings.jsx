...
function ManageBookings(){
    ...
    async function fetchOwnerBooking(){
        try{
    ...
    return(
        <>
            <div className="px-4 pt-10 md:px-10 w-full">
                <Title title="Manage Bookings" subTitle="Track all customer bookings, approve or cancel requests, and amanage booking statuses."></Title>
                                    ...
                                    <td className="p-3">
                                        {booking.status == "pending" ? (
                                            ...
                                            <span className={`px-3 py-1 rounded-full text-xs font-semibold
                                                ${booking.status === "confirmed" ? 'bg-green-100 text-green-500' : 'bg-red-100 text-red-500'}`}>{booking.status}
                                            </span>
                                        )}
                                    </td>
                                </tr> 
