...
function ManageCars(){
    ...
    async function fetchOwnerCars(e){
        try{
    ...
    return (
        <>
            <div className="px-4 pt-10 md:px-10 w-full">
                <Title title="Manage Cars" subTitle="View all listed cars, update their details, or remove them from the booking platform"></Title>
                        ...
                        <tbody>
                            {cars.map((car, index)=>(
                                <tr key={index} className="border-t border-borderColor">
                                    ...
                                    <td className="felx itmes-center p-3">
                                        <img src={car.isAvailable ? assets.eye_close_icon : assets.eye_icon} alt=""
                                        onClick={()=>toggleAvailability(car._id)}  className="cursor-pointer"/>
